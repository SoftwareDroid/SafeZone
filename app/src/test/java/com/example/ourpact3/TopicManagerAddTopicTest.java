...
public class TopicManagerAddTopicTest
{
    ...
    @Test
    public void testAddTopic_NullTopicId() {
    ...
    @Test
    public void testAddTopic_InvalidTopicId() {
    ...
    @Test
    public void testAddTopic_DuplicateLanguage() {
    ...
    @Test
    public void testAddTopic_NoCycle() {
        Topic topic1 = new Topic("id1", "en");
    ...
    @Test
    public void testAddTopic_Cycle() {
        Topic topic1 = new Topic("id1", "en");
        topic1.setIncludedTopics(new ArrayList<>(Arrays.asList("id2")));
