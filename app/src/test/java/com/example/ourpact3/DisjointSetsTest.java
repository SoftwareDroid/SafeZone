...
public class DisjointSetsTest
{
    ...
    public void testMyCalculateDisjointSets()
    {
        ...
        B.add(new HashSet<>(Arrays.asList(1, 0, 4)));     // Set 2
        B.add(new HashSet<>(Arrays.asList(2, 10)));        // Set 3

        Set<Integer>[] result = DisjointSets.myCalculateDisjointSets(A, B);
        assertTrue(result[0].contains(5));
